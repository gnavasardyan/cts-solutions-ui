...
- **Обновлены роли пользователей в системе регистрации**: Упрощены названия ролей
  - Оператор заказчика
  - Оператор производства
...
### Боковое меню для администратора (январь 18, 2025)
- **Новый дизайн для админа**: Заменена верхняя навигация на боковое меню
  - ✅ Боковая панель слева с логотипом и навигацией
  - ✅ Иконки для каждого раздела (Lucide React)
  - ✅ Каталог добавлен в боковое меню
  - ✅ Информация о пользователе внизу панели
  - ✅ Кнопка выхода в боковой панели
  - ✅ Переключатель темы в боковой панели
- **Адаптивный интерфейс**: Администраторы видят боковое меню, остальные роли - верхнюю навигацию
- **Улучшенная эргономика**: Быстрый доступ ко всем разделам системы для администраторов
